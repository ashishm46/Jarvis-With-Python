...
def wishMe():
    ...
    weather()
    speak('I am Your Jarvis. Please tell me how can I help you SIR?')
    ...
    while True:
        ...
        if 'jarvis are you there' in query:
            ...
            if platform == "win32" or "darwin":
                speak('Ashish Mishra is my master. He created me couple of days ago')
